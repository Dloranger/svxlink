...
proc squelch_open {is_open} {
  # The listen_only_active and CFG_REMOTE_COURTESY_TONE global variables are set by
  # the C++ code
  variable listen_only_active
  variable CFG_REMOTE_COURTESY_TONE
  if {$CFG_REMOTE_COURTESY_TONE && !$is_open && !$listen_only_active} {
    playSilence 200
    playTone 1000 100 100
  }
}
