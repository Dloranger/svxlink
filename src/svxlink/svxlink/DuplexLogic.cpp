...
DuplexLogic::DuplexLogic(Async::Config& cfg, const std::string& name)
    ...
    ident_nag_min_time(2000), ident_nag_timer(-1)
{
  ...
  open_on_sql_timer.expired.connect(
      mem_fun(*this, &DuplexLogic::openOnSqlTimerExpired));
  idle_sound_timer.expired.connect(
      mem_fun(*this, &DuplexLogic::playIdleSound));
  ident_nag_timer.expired.connect(mem_fun(*this, &DuplexLogic::identNag));
  timerclear(&rpt_close_timestamp);
  timerclear(&sql_up_timestamp);
} /* DuplexLogic::DuplexLogic */


DuplexLogic::~DuplexLogic(void)
{
} /* DuplexLogic::~DuplexLogic */


bool DuplexLogic::initialize(void)
{
  if (!Logic::initialize())
  {
    return false;
  ...
  rx().toneDetected.connect(mem_fun(*this, &DuplexLogic::detectedTone));
  ...
  idleStateChanged.connect(mem_fun(*this, &DuplexLogic::setIdle));
...
} /* DuplexLogic::processEvent */


bool DuplexLogic::activateModule(Module *module)
{
  open_reason = "MODULE";
  setUp(true, open_reason);
  return Logic::activateModule(module);
} /* DuplexLogic::activateModule */


void DuplexLogic::setOnline(bool online)
{
...
} /* DuplexLogic::setOnline */


void DuplexLogic::dtmfDigitDetected(char digit, int duration)
{
  if (repeater_is_up)
  {
...
} /* DuplexLogic::dtmfDigitDetected */


void DuplexLogic::selcallSequenceDetected(std::string sequence)
{
  if (repeater_is_up)
  {
...
} /* DuplexLogic::selcallSequenceDetected */
...
void DuplexLogic::allMsgsWritten(void)
{
...
void DuplexLogic::dtmfCtrlPtyCmdReceived(const void *buf, size_t count)
{
  if (!repeater_is_up)
  {
...
} /* DuplexLogic::dtmfCtrlPtyCmdReceived */


#if 0
bool DuplexLogic::getIdleState(void) const
{
  /*
...
void DuplexLogic::idleTimeout(Timer *t)
{
  //printf("DuplexLogic::idleTimeout\n");
  setUp(false, "IDLE");
} /* DuplexLogic::idleTimeout */


void DuplexLogic::setIdle(bool idle)
{
...
void DuplexLogic::setUp(bool up, string reason)
{
  //printf("DuplexLogic::setUp: up=%s  reason=%s\n",
...
void DuplexLogic::squelchOpen(bool is_open)
{
...
} /* DuplexLogic::squelchOpen */


void DuplexLogic::detectedTone(float fq)
{
...
} /* DuplexLogic::detectedTone */


void DuplexLogic::playIdleSound(Timer *t)
{
  processEvent("repeater_idle");
} /* DuplexLogic::playIdleSound */


void DuplexLogic::openOnSqlTimerExpired(Timer *t)
{
  open_on_sql_timer.setEnable(false);
  open_reason = "SQL";
  activateOnOpenOrClose(open_sql_flank);
} /* DuplexLogic::openOnSqlTimerExpired */


void DuplexLogic::activateOnOpenOrClose(SqlFlank flank)
{
...
void DuplexLogic::identNag(Timer *t)
{
  ident_nag_timer.setEnable(false);
